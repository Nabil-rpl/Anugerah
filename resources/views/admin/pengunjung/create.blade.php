...
<head>
    ...
    <title>Tambah Pengunjung - Laravel 12</title>
        ...
        <div class="row">
            ...
            <div class="col-md-10 p-0 main-content">
                ...
                <div class="topbar d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-0">Tambah Pengunjung</h4>
                        <small class="text-muted">Tambah data pengunjung baru</small>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('lokasi_pengisi') is-invalid @enderror" 
                                                   name="lokasi_pengisi" value="{{ old('lokasi_pengisi') }}">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('alamat_lengkap') is-invalid @enderror" 
                                                      name="alamat_lengkap" rows="3">{{ old('alamat_lengkap') }}</textarea>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('kode_provinsi') is-invalid @enderror" 
                                                   name="kode_provinsi" value="{{ old('kode_provinsi') }}" maxlength="2">
                                            @error('kode_provinsi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('kode_kota') is-invalid @enderror" 
                                                   name="kode_kota" value="{{ old('kode_kota') }}" maxlength="4">
                                            @error('kode_kota')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('kode_kecamatan') is-invalid @enderror" 
                                                   name="kode_kecamatan" value="{{ old('kode_kecamatan') }}" maxlength="7">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('kode_kelurahan') is-invalid @enderror" 
                                                   name="kode_kelurahan" value="{{ old('kode_kelurahan') }}" maxlength="10">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control @error('pesan') is-invalid @enderror" 
                                                      name="pesan" rows="3">{{ old('pesan') }}</textarea>
                                            @error('pesan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
