        ...
        <div class="card-body">
            <form action="{{ route('admin.client.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="nomor_pelanggan" class="form-label">Nomor Pelanggan <span class="text-danger">*</span></label>
                            <input type="text" 
                                   class="form-control @error('nomor_pelanggan') is-invalid @enderror" 
                                   id="nomor_pelanggan" 
                                   name="nomor_pelanggan" 
                                   value="{{ old('nomor_pelanggan', $nomorPelanggan) }}" 
                                   required
                                   readonly
                                   maxlength="10">
                            <small class="text-muted">Nomor pelanggan generate otomatis</small>
